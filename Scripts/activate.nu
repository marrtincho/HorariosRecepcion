...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Martin\Documents\Python_Proyects\HorariosSHClaude'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Martin\Documents\Python_Proyects\HorariosSHClaude\Scripts\deactivate.nu'
